...
const server = new Server({ name: "mcp-search-fetch", version: "0.1.0" }, {
    capabilities: {
        tools: {}
    }
});
...
server.tool("search", "Find items by keyword and return IDs to pass to `fetch`.", SearchInput, SearchOutput, async (request) => {
...
// @ts-ignore - tool method exists but TypeScript types may not be updated
server.tool("fetch", "Return full content for a prior search result.", FetchInput, FetchOutput, async (request) => {
